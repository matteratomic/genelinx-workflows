...
export const OTPTemplate = {
  ...
  description:
    "We'd like to confirm your email address before proceeding further",
  emailLabel: "Email",
  buttonText: "Send OTP",
...
export const PatientDetailsTemplate = {
  ...
  questions: [
    ...
    },
    {
      ...
      options: ["Male", "Female"],
      helpText:
        "We ask this question as the risks for some conditions depend on this information",
    },
    {
      id: "pronouns",
      type: "radio",
    ...
    },
    {
      ...
      type: "checkbox",
      question:
        "What is your ethnic background on your maternal (mother's) side?",
      required: true,
      helpText:
        "We ask this question as the risks for some conditions depend on this information",
      options: [
    ...
    },
    {
      ...
      type: "checkbox",
      question:
        "What is your ethnic background on your paternal (father's) side?",
      required: true,
      helpText:
        "We ask this question as the risks for some conditions depend on this information",
      options: [
    ...
    // },
    {
      ...
      helpText:
        "You can find this at the top right corner of the final summary letter since Dementia in your relative or in their appointment booking email. If you do not have this information please enter their First Name, Last Name and Date of Birth.",
    },
    {
      id: "reason",
      type: "textarea",
...
export const MedicalHistoryTemplate = {
  ...
  questions: [
    ...
    },
    {
      ...
      type: "radio",
      question:
        "Have you ever taken the oral contraceptive (birth control) pill?",
      options: ["Yes", "No"],
      required: true,
    },
    {
...
export const OptionalQuestionnaireTemplate = {
  ...
  subtitle:
    "These are optional consents and will not affect the service provided by GeneLinx. You can revoke your consent at any time. Please refer to our privacy policy for further information.",
  questions: [
    // {
...
export const BookingConsultationTemplate = {
  ...
  contactInfo:
    "If you have any questions please do not hesitate to contact us at appointments@gene-linx.com with your last name and booking ID.",
  steps: [
    {
      id: "welcome",
      title: "Welcome",
  ...
  form: {
    ...
    countryCode: {
      ...
      options: [
        ...
        { value: "+599", label: "+599" }, // Curaçao & Bonaire
  ...
  sections: [
    {
      ...
      image: "https://gene-linx.com/wp-content/uploads/2024/06/Image-217-1.png",
      inlineImage:
        "https://gene-linx.com/wp-content/uploads/2024/06/cencer.png",
      items: [
        "I was diagnosed with cancer",
        "I have a family history of cancer",
        "I need to be tested for a familial cancer genetic change",
    ...
    },
    {
      ...
      price: "€249",
      image:
        "https://gene-linx.com/wp-content/uploads/2024/06/2566956f-1c28-4b79-aa7c-d02a303949f1-scaled.jpg",
      inlineImage:
        "https://gene-linx.com/wp-content/uploads/2024/06/health.png",
      items: [
        "I am planning a pregnancy and want to know my risks",
        "I have a history of stillbirths or miscarriages",
        "I want to understand genetic test options in pregnancy",
    ...
    },
    {
      ...
      price: "€249",
      image:
        "https://gene-linx.com/wp-content/uploads/2024/06/da10fbd7-db1e-4dd8-83b6-acfe473b24d3-scaled-e1724788042727.jpg",
    ...
    },
    {
      ...
      price: "€249",
      image:
        "https://gene-linx.com/wp-content/uploads/2024/06/1d1e6d3e-a83c-4575-b458-e2583f9bf4d0-scaled-e1724787499961.jpg",
    ...
    questions: [
      {
        question: "What is genetic counselling and who provides this?",
        answer:
          "Genetic counselling is a healthcare service that provides information and support to people who have, or may be at risk for, genetic conditions. It is provided by certified genetic counsellors who have specialized training in medical genetics and counselling.",
      },
      {
        question: "Who should have genetic counselling?",
        answer:
          "Genetic counselling may be beneficial for individuals who have a personal or family history of genetic conditions, are planning a pregnancy, have experienced multiple miscarriages, or are interested in understanding their genetic health risks.",
      },
      // Add more FAQ items as needed
    ],
  },
  ...
  sections: [
    {
      ...
      content: {
        ...
        description:
          "Learn the basic principles of genetics, inheritance patterns, and the role of genetic testing in healthcare.",
        topics: [
    ...
    },
    {
      ...
      question:
        "After reviewing the information provided would you like to proceed to testing?",
      options: ["Yes", "No"],
    },
  ],
};
...
export const ConsentFormTemplate = {
  ...
  logos: [
    "https://gene-linx.com/wp-content/uploads/2023/02/Logo-files2-01-1.svg",
  ],
  studyInfo: [
    {
    ...
    },
    {
      ...
      value:
        "Principal Genetic Counsellor, Cancer Genetic Service and Assistant Professor, Trinity College Dublin",
    },
    {
    ...
    },
    {
      ...
      value:
        "Consultant Oncologist and Cancer Geneticist, Clinical Lead of Cancer Genetic Service",
    },
    {
      label: "Data Controller's/joint Controller's Identity:",
      value: ["St James Hospital", "Dublin, Ireland"],
    },
  ],
  generalQuestions: [
