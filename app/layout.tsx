    ...
    <html lang="en">
      <body className={`${inter.className} h-screen antialiased`}>
        <Card className="flex items-center px-8 w-full rounded-none h-16 z-50 relative">
          ...
          <div
            role="button"
            className="ml-auto cursor-pointer flex items-center space-x-3"
          >
